...
*
* Auxiliary class that filters games by their names.
*/
...
public class GameDataDirFilter implements FileFilter
{
	private String ifid = "";
	public GameDataDirFilter(String ifid){ this.ifid = ifid; }
	
	public boolean accept(File file)
	{
		if (file.getName().endsWith(ifid))
			return true;
		else
			return false;
	}
