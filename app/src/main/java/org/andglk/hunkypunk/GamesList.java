...
*
*
*	GamesList makes it possible if the App is started for first time to download
*	some special IFs. GamesList also lists all IFs which are stored in the IFDB.
*/
