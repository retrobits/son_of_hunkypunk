...
*
*
	Does work on pointers (allocating buffer memory and length(120)).
	Also rocks: rocks are unique identifiers for each event/game object,
	provided for developer's purposes. In SoHP they are passed on to the 
	different types of windows in the Window class which directly extends
	CPointed. Rocks (dispatchRocks) are being set in the MemoryStream-Constructor.
...
*            All contributors as of GNU GPL are in a way stated.
*
*  Defines a 'CPointed' object that manages pointers and rocks.
*/
>>>>>>> 4443f02b5001f4c3b2be6266ca4acfbd8e065bbe
